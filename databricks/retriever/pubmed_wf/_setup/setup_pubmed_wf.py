...
#  This setup file is used across all workflow tasks in pubmed_wf

#  Tasks performed:
#    - Install Library Dependencies (if needed)
#    - Define & Set Paths: PROJECT_ROOT_PATH, PYTHON_ROOT_PATH
#    - Load config_pubmed_wf from YAML
#    - Instantiate Workflow_pubmed_wf config class
#    - Optionally display architecture or table diagrams

# COMMAND ----------

# DBTITLE 1, Install Agent Library Dependencies (If not done in cluster setup, uncomment below)
# import subprocess
# commands = [
...
# DBTITLE 1, Load config & Instantiate pubmed_wf
import yaml
import json
...
html_configs = (
    'The config class, <i>Workflow_pubmed_wf</i>, has been instantiated as <b>pubmed_wf</b>.<br>'
...
dbutils.widgets.dropdown(name="SHOW_TABLE", defaultValue="false", choices=["false", "true"])
dbutils.widgets.dropdown(name="SHOW_WORKFLOW", defaultValue="false", choices=["false", "true"])
