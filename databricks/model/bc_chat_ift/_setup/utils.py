...
#Return the current cluster id to use to read the dataset and send it to the fine tuning cluster. See https://docs.databricks.com/en/large-language-models/foundation-model-training/create-fine-tune[...]
...
# For chat model
def make_chat_prompt(context: str, question: str, answer: str, mistral=False) -> List[dict]:
